...
</style></head><body><main><header><h1>Strider open-source corpus</h1><p class="lede">Pinned, repeatable format, lint, and analysis results across 10 Go projects. Total wall time: {{seconds .TotalMS}}.</p></header>
