...
var extendedCatalog = []spec{
	...
	{"redundant-atomic-result-assignment", "avoid assigning an atomic result back to its operand", "standard sync/atomic patterns"},
	...
	{"boolean-literal-comparison", "simplify comparisons between booleans and literals", "enabled"},
	...
	{"deferred-recover-call", "defer recover through a function closure", "enabled"},
	{"discarded-deferred-result", "avoid return values discarded by deferred calls", "enabled"},
	...
	{"empty-conditional-block", "detect empty conditional blocks", "enabled"},
	...
	{"error-last-result", "place error last in result lists", "enabled"},
	{"error-strings", "use lower-case unpunctuated error messages", "enabled"},
	{"prefer-fmt-errorf", "replace errors.New around fmt.Sprintf", "enabled"},
	{"exported-declaration-comment", "document exported declarations", "enabled"},
	{"file-length-limit", "limit source-file length", "maximum 500 lines; set 0 to disable"},
	...
	{"get-function-return-value", "require Get-prefixed functions to return values", "enabled"},
	{"identical-branches", "detect identical if branches", "enabled"},
	{"identical-if-chain-branches", "detect repeated if-chain branches", "enabled"},
	{"identical-if-chain-conditions", "detect repeated if-chain conditions", "enabled"},
	...
	{"redundant-error-return-check", "simplify redundant error checks before returning", "enabled"},
	...
	{"range-value-address", "avoid taking addresses of range values", "enabled"},
	...
	{"redundant-final-return", "remove final returns from resultless functions", "enabled"},
	{"redundant-switch-break", "remove redundant breaks from switch cases", "enabled"},
	{"single-case-switch", "replace single-case switches with if statements", "enabled"},
	...
	{"invalid-struct-tag", "validate struct tag syntax and options", "standard tags"},
	...
	{"insecure-url-scheme", "detect insecure URL schemes", "HTTP, WS, and FTP"},
